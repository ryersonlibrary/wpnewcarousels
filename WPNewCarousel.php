...
function wpnewcarousel_script() {
  ...
  /* Monkeypatch to fix HTTPS compat issues. */
  ...
  wp_enqueue_script('wpnewcarousel_script', plugins_url('/wpnewcarousels/js/jquery.nivo.slider.js'), array('jquery'));  
}
function WPNewCarousel_Styles() {
  ...
  wp_enqueue_style('WPNewCarousel_Styles', plugins_url('/wpnewcarousels/css/carousel.css'));
}
